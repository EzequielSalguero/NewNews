...
public class ComentarioJpaController implements Serializable {
    ...
    public List obtenerComentariosNoticia(int cod){
        EntityManager em = getEntityManager();
        TypedQuery<Comentario> query = em.createNamedQuery("Comentario.findByCodNoticia", Comentario.class);
        query.setParameter("codNoticia", cod);
